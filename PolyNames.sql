...
CREATE TABLE `Joueur` (`id` INT NOT NULL AUTO_INCREMENT, `nom` VARCHAR(50) NOT NULL, `role` INT NOT NULL, `partie` INT NOT NULL, PRIMARY KEY(`id`), CONSTRAINT `fonction` FOREIGN KEY (`role`) REFERENCES `Role` (`id`), CONSTRAINT `jouer` FOREIGN KEY (`partie`) REFERENCES `Partie` (`id`));
